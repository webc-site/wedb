...
impl<'a> RecordMut<'a> {
  ...
  /// 基于 FillerWords 与动态松弛写入新值的公共实现（严格对标 C# Garnet LogRecord.TrySetPinnedValueSpan & InternalRMW.cs）
  ///
  ...
  /// 基于 FillerWords 与动态松弛的原位值更新（严格对标 C# Garnet LogRecord.TrySetPinnedValueSpan & InternalRMW.cs）
  ///
