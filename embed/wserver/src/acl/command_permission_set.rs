...
impl CommandPermissionSet {
    ...
    pub fn can_run_command() { unimplemented!() }
    /// libs/server/ACL/CommandPermissionSet.cs:CanRunCustomCommand
    pub fn can_run_custom_command() { unimplemented!() }
    ...
    pub fn is_equivalent_to() { unimplemented!() }
    /// libs/server/ACL/CommandPermissionSet.cs:GetCommandListLength
    pub fn get_command_list_length() { unimplemented!() }
}
