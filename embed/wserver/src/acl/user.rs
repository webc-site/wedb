...
impl User {
    ...
    pub fn can_access_command() { unimplemented!() }
    /// libs/server/ACL/User.cs:CanAccessCustomCommand
    pub fn can_access_custom_command() { unimplemented!() }
    /// libs/server/ACL/User.cs:AddCategory
    pub fn add_category() { unimplemented!() }
    /// libs/server/ACL/User.cs:AddCommand
    pub fn add_command() { unimplemented!() }
    /// libs/server/ACL/User.cs:RemoveCategory
    pub fn remove_category() { unimplemented!() }
    /// libs/server/ACL/User.cs:RemoveCommand
    pub fn remove_command() { unimplemented!() }
    /// libs/server/ACL/User.cs:AddCustomCommand
    pub fn add_custom_command() { unimplemented!() }
    /// libs/server/ACL/User.cs:RemoveCustomCommand
    pub fn remove_custom_command() { unimplemented!() }
    /// libs/server/ACL/User.cs:AddPasswordHash
    pub fn add_password_hash() { unimplemented!() }
    /// libs/server/ACL/User.cs:RemovePasswordHash
    pub fn remove_password_hash() { unimplemented!() }
    /// libs/server/ACL/User.cs:ClearPasswords
    pub fn clear_passwords() { unimplemented!() }
    /// libs/server/ACL/User.cs:ValidatePassword
    pub fn validate_password() { unimplemented!() }
    /// libs/server/ACL/User.cs:DescribeUser
    pub fn describe_user() { unimplemented!() }
    /// libs/server/ACL/User.cs:GetEnabledCommandsDescription
    pub fn get_enabled_commands_description() { unimplemented!() }
    /// libs/server/ACL/User.cs:DetermineCommandDetails
    pub fn determine_command_details() { unimplemented!() }
    /// libs/server/ACL/User.cs:RationalizeACLDescription
    pub fn rationalize_acl_description() { unimplemented!() }
    /// libs/server/ACL/User.cs:CopyCommandPermissionSet
    pub fn copy_command_permission_set() { unimplemented!() }
    /// libs/server/ACL/User.cs:CopyPasswordHashes
    pub fn copy_password_hashes() { unimplemented!() }
}
