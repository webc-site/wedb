...
impl SessionScriptCache {
    ...
    pub fn start_running_script() { unimplemented!() }
    /// libs/server/Lua/SessionScriptCache.cs:StopRunningScript
    pub fn stop_running_script() { unimplemented!() }
