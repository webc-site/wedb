...
impl LuaRunner_Functions_Struct {
    ...
    pub fn add_alignment_padding() { unimplemented!() }
    ...
    pub fn try_encode_single() { unimplemented!() }
    /// libs/server/Lua/LuaRunner.Functions.Struct.cs:TryEncodeDouble
    pub fn try_encode_double() { unimplemented!() }
    /// libs/server/Lua/LuaRunner.Functions.Struct.cs:TryEncodeBytes
    ...
    pub fn try_decode_integer() { unimplemented!() }
    ...
    pub fn try_decode_character() { unimplemented!() }
    /// libs/server/Lua/LuaRunner.Functions.Struct.cs:TryDecodeString
    pub fn try_decode_string() { unimplemented!() }
