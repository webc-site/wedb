...
impl LuaRunner {
  /// libs/server/Lua/LuaRunner.cs:SendAndReset
  pub fn send_and_reset() {
    unimplemented!()
  }
  /// libs/server/Lua/LuaRunner.cs:Register
  pub fn register() {
    unimplemented!()
  }
  ...
  pub fn try_probe_support() {
    unimplemented!()
  }
  /// libs/server/Lua/LuaRunner.cs:InitializeNoScriptDetails
  pub fn initialize_no_script_details() {
    unimplemented!()
  }
}
