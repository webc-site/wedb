...
impl GarnetInfoMetrics {
  ...
  pub fn get_section_resp_info() {
    unimplemented!()
  }
  /// libs/server/Metrics/Info/GarnetInfoMetrics.cs:GetRespInfo
  pub fn get_resp_info() {
    unimplemented!()
  }
  /// libs/server/Metrics/Info/GarnetInfoMetrics.cs:GetMetricInternal
  pub fn get_metric_internal() {
    unimplemented!()
  }
