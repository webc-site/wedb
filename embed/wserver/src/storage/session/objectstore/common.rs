...
impl Common {
    ...
    pub fn rmw_object_store_operation() { unimplemented!() }
    /// libs/server/Storage/Session/ObjectStore/Common.cs:ReadObjectStoreOperation
    pub fn read_object_store_operation() { unimplemented!() }
