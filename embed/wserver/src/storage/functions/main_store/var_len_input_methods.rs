...
impl MainSessionFunctions {
  /// libs/server/Storage/Functions/MainStore/VarLenInputMethods.cs:GetRMWModifiedValueLength
  ...
  /// libs/server/Storage/Functions/MainStore/VarLenInputMethods.cs:GetRMWInitialValueLength
