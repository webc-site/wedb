use crate::{arg_slice::ArgSlice, inputs::StringInput};

/// libs/server/Storage/Functions/MainStore/MainSessionFunctions.cs:MainSessionFunctions
#[derive(Clone)]
...
impl MainSessionFunctions {
  ...
  /// libs/server/Storage/Functions/MainStore/MainSessionFunctions.cs:ConvertOutputToHeap
  ...
  /// libs/server/Storage/Functions/MainStore/MainSessionFunctions.cs:PostSingleKeyConsistentReadCallback
  pub fn post_single_key_consistent_read_callback(&self) {}

  /// libs/server/Storage/Functions/MainStore/MainSessionFunctions.cs:PreBatchKeyConsistentReadCallback
  pub fn pre_batch_key_consistent_read_callback(&self, _parameters: &[ArgSlice]) {}

  /// libs/server/Storage/Functions/MainStore/MainSessionFunctions.cs:PostBatchKeyConsistentReadCallback
