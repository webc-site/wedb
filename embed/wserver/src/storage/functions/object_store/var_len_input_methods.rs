...
impl ObjectSessionFunctions {
  /// libs/server/Storage/Functions/ObjectStore/VarLenInputMethods.cs:GetRMWModifiedValueLength
  ...
  /// libs/server/Storage/Functions/ObjectStore/VarLenInputMethods.cs:GetRMWInitialValueLength
