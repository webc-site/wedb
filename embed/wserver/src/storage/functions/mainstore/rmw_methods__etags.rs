pub struct RMWMethods_Etags;

impl RMWMethods_Etags {
  ...
  pub fn handle_del_if_greater_in_place_update() {
    unimplemented!()
  }
  ...
  pub fn handle_set_with_etag_copy_update() {
    unimplemented!()
  }
}
