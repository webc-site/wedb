use crate::input_header::RespInputHeader;
use crate::session_parse_state::SessionParseState;
use crate::types::{RespCommand, RespInputFlags};
...
impl ObjectInput {
    ...
    pub fn new_with_state(header: RespInputHeader, parse_state: &mut SessionParseState, arg1: i32, arg2: i32) -> Self {
        Self {
            header,
            arg1,
            arg2,
    ...
    pub fn new_with_state_offset(header: RespInputHeader, parse_state: &mut SessionParseState, start_idx: usize, arg1: i32, arg2: i32) -> Self {
        Self {
            header,
            arg1,
            arg2,
    ...
    pub fn serialized_length(&self) -> usize {
        RespInputHeader::SIZE + (2 * std::mem::size_of::<i32>()) + self.parse_state.get_serialized_length()
    }

    pub unsafe fn copy_to(&self, dest: *mut u8, length: usize) -> usize { unsafe {
    ...
    pub unsafe fn deserialize_from(&mut self, src: *const u8) -> usize { unsafe {
        let mut curr = src;
...
impl StringInput {
    ...
    pub fn new_with_state(cmd: RespCommand, parse_state: &mut SessionParseState, arg1: i64, flags: RespInputFlags) -> Self {
        Self {
            header: RespInputHeader::new_with_cmd(cmd, flags),
            arg1,
            parse_state: parse_state.clone(),
    ...
    pub fn new_with_state_offset(cmd: RespCommand, parse_state: &mut SessionParseState, start_idx: usize, arg1: i64, flags: RespInputFlags) -> Self {
        Self {
            header: RespInputHeader::new_with_cmd(cmd, flags),
            arg1,
            parse_state: parse_state.slice(start_idx),
...
impl CustomProcedureInput {
    ...
    pub fn new_with_state_offset(parse_state: &mut SessionParseState, start_idx: usize, resp_version: u8) -> Self {
        Self {
            parse_state: parse_state.slice(start_idx),
            resp_version,
        }
    ...
    pub unsafe fn deserialize_from(&mut self, src: *const u8) -> usize { unsafe {
        self.parse_state.deserialize_from(src)
    }}
}
