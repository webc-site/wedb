...
impl ReadConsistencyManager {
  ...
  pub fn build_virtual_sublog_replay_states() {
    unimplemented!()
  }
  ...
  pub fn advance_virtual_sublog_time() {
    unimplemented!()
  }
