...
impl GarnetAppendOnlyFile {
    ...
    pub fn total_size() { unimplemented!() }
    ...
    pub fn get_larger_than_maximum_sequence_number() { unimplemented!() }
    /// libs/server/AOF/GarnetAppendOnlyFile.cs:CreateOrUpdateKeySequenceManager
    pub fn create_or_update_key_sequence_manager() { unimplemented!() }
    /// libs/server/AOF/GarnetAppendOnlyFile.cs:ResetSequenceNumberGenerator
    pub fn reset_sequence_number_generator() { unimplemented!() }
    /// libs/server/AOF/GarnetAppendOnlyFile.cs:ComputeAofSyncReplayAddress
    pub fn compute_aof_sync_replay_address() { unimplemented!() }
    /// libs/server/AOF/GarnetAppendOnlyFile.cs:ComputeAofSubloSyncReplayAddress
    pub fn compute_aof_sublo_sync_replay_address() { unimplemented!() }
    /// libs/server/AOF/GarnetAppendOnlyFile.cs:DataLossCheck
    pub fn data_loss_check() { unimplemented!() }
}
