...
impl AofAddress {
    ...
    pub fn from_span() { unimplemented!() }
    /// libs/server/AOF/AofAddress.cs:FromString
    pub fn from_string() { unimplemented!() }
    /// libs/server/AOF/AofAddress.cs:SetValueIf
    pub fn set_value_if() { unimplemented!() }
