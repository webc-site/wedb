...
impl GarnetLog {
    ...
    pub fn get_sequence_number_from_cookie() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:HASH
    pub fn hash() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:GetPhysicalSublogIdx
    pub fn get_physical_sublog_idx() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:GetReplayTaskIdx
    pub fn get_replay_task_idx() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:GetVirtualSublogIdx
    pub fn get_virtual_sublog_idx() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:RecoverLatestSequenceNumber
    pub fn recover_latest_sequence_number() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:AllLogsBitmask
    pub fn all_logs_bitmask() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:LockSublogs
    pub fn lock_sublogs() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:UnlockSublogs
    pub fn unlock_sublogs() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:GetSubLog
    pub fn get_sub_log() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:GetBeginAddress
    pub fn get_begin_address() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:SetLogShiftTailCallback
    pub fn set_log_shift_tail_callback() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:ScanSingle
    pub fn scan_single() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:UnsafeGetLogPageSizeBits
    pub fn unsafe_get_log_page_size_bits() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:UnsafeGetReadOnlyAddressAbove
    pub fn unsafe_get_read_only_address_above() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:UnsafeShiftBeginAddress
    pub fn unsafe_shift_begin_address() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:TruncateUntil
    pub fn truncate_until() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:SafeInitialize
    pub fn safe_initialize() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:InitializeIf
    pub fn initialize_if() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:WaitForCommit
    pub fn wait_for_commit() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:CommitAsync
    pub fn commit_async() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:WaitForCommitAsync
    pub fn wait_for_commit_async() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:BackpressureWaitKey
    pub fn backpressure_wait_key() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:BackpressureWaitKeyHash
    pub fn backpressure_wait_key_hash() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:BackpressureWaitVector
    pub fn backpressure_wait_vector() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:Enqueue
    pub fn enqueue() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:IsChunkable
    pub fn is_chunkable() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:EnqueueSpanChunked
    pub fn enqueue_span_chunked() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:EnqueueObjectChunked
    pub fn enqueue_object_chunked() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:ChunkBufferSize
    pub fn chunk_buffer_size() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:EnqueueStoredProc
    pub fn enqueue_stored_proc() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:EnqueueTxn
    pub fn enqueue_txn() { unimplemented!() }
    /// libs/server/AOF/GarnetLog.cs:EnqueueBroadcastEntry
    pub fn enqueue_broadcast_entry() { unimplemented!() }
    ...
    pub fn enqueue_safe_flush_aof() { unimplemented!() }
}
