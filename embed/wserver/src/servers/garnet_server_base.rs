...
impl GarnetServerBase {
  ...
  pub fn increment_connections_received() {
    unimplemented!()
  }
  /// libs/server/Servers/GarnetServerBase.cs:IncrementConnectionsDisposed
  pub fn increment_connections_disposed() {
    unimplemented!()
  }
  ...
  pub fn active_cluster_sessions() {
    unimplemented!()
  }
  /// libs/server/Servers/GarnetServerBase.cs:get_conn_active
  pub fn get_conn_active() {
    unimplemented!()
  }
  /// libs/server/Servers/GarnetServerBase.cs:ResetConnectionsReceived
  pub fn reset_connections_received() {
    unimplemented!()
  }
  /// libs/server/Servers/GarnetServerBase.cs:ResetConnectionsDiposed
  pub fn reset_connections_diposed() {
    unimplemented!()
  }
  ...
  /// libs/server/Servers/GarnetServerBase.cs:DisposeActiveHandlers
  pub fn dispose_active_handlers() {
    unimplemented!()
  }
}
