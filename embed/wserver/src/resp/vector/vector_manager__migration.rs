...
impl VectorManager_Migration {
  ...
  pub fn get_migrated_index_key_serialization_size() {
    unimplemented!()
  }
  ...
  pub fn deserialize_migrated_index_key() {
    unimplemented!()
  }
}
