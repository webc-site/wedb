...
impl RespCommand {
    ...
    pub fn is_allowed_in_subscription_mode() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:FastParseInlineCommand
    pub fn fast_parse_inline_command() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:FastParseCommand
    pub fn fast_parse_command() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:MatchedNone
    pub fn matched_none() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:SimdFastParse
    pub fn simd_fast_parse() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:TryParseCustomCommand
    pub fn try_parse_custom_command() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:AttemptSkipLine
    pub fn attempt_skip_line() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:ParseRespCommandBuffer
    pub fn parse_resp_command_buffer() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:FuzzParseCommandBuffer
    pub fn fuzz_parse_command_buffer() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:ParseCommand
    pub fn parse_command() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:UpdateCommandCache
    pub fn update_command_cache() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:HandleAofCommitMode
    pub fn handle_aof_commit_mode() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:ArrayParseCommand
    pub fn array_parse_command() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:HashLookupCommand
    pub fn hash_lookup_command() { unimplemented!() }
    /// libs/server/Resp/Parser/RespCommand.cs:HandleSubcommandLookup
    pub fn handle_subcommand_lookup() { unimplemented!() }
}
