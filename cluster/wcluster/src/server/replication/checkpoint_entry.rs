...
impl CheckpointEntry {
    /// libs/cluster/Server/Replication/CheckpointEntry.cs:LogCheckpointEntry
    pub fn log_checkpoint_entry(&self) {}
    /// libs/cluster/Server/Replication/CheckpointEntry.cs:GetMinAofCoveredAddress
    pub fn get_min_aof_covered_address(&self) {}
    /// libs/cluster/Server/Replication/CheckpointEntry.cs:TryAddReader
    pub fn try_add_reader(&self) {}
