...
impl ReplicaReplayDriver {
  ...
  /// libs/cluster/Server/Replication/ReplicaOps/AOFReplay/ReplicaReplayDriver.cs:Consume
  pub fn consume(&self) {}
  /// libs/cluster/Server/Replication/ReplicaOps/AOFReplay/ReplicaReplayDriver.cs:ConsumeSchedulePage
  pub fn consume_schedule_page(&self) {}
  /// libs/cluster/Server/Replication/ReplicaOps/AOFReplay/ReplicaReplayDriver.cs:ConsumeDirect
  pub fn consume_direct(&self) {}
