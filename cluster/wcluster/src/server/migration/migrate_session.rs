...
use crate::server::migration::migrate_state::MigrateState;
use crate::server::migration::sketch::Sketch;
use crate::server::migration::migration_manager::TransferOption;
...
impl MigrateOperation {
    ...
    pub async fn initialize_async(&self) -> bool { true }
    ...
    pub async fn transmit_slots_async(&self) -> bool { true }

    /// libs/cluster/Server/Migration/MigrateOperation.cs:TransmitKeysAsync
    pub async fn transmit_keys_async(&self) -> bool { true }

    /// libs/cluster/Server/Migration/MigrateOperation.cs:TransmitKeysNamespacesAsync
    pub async fn transmit_keys_namespaces_async(&self) -> bool { true }
...
impl MigrateSession {
    ...
    pub fn overlap(&self, _other: &MigrateSession) -> bool { false }

    /// libs/cluster/Server/Migration/MigrateSession.cs:GetGarnetClient
    pub fn get_garnet_client(&self) -> Arc<GarnetClient> { Arc::new(GarnetClient::new()) }
    ...
    pub async fn check_connection_async(&self, _client: Arc<GarnetClient>) -> bool { true }

    /// libs/cluster/Server/Migration/MigrateSession.cs:GetRanges
    pub fn get_ranges(&self) -> Vec<(i32, i32)> { vec![] }
    ...
    pub fn try_prepare_local_for_migration(&self) -> bool { true }
