...
pub struct ClusterManagerWorkerState;

impl ClusterManagerWorkerState {
  /// libs/cluster/Server/ClusterManagerWorkerState.cs:TryRemoveWorker
  pub fn try_remove_worker(&self) {}
