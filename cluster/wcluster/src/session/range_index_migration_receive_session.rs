/// libs/cluster/Session/RangeIndexMigrationReceiveSession.cs:RangeIndexMigrationReceiveSession
pub struct RangeIndexMigrationReceiveSession;

impl RangeIndexMigrationReceiveSession {
    /// libs/cluster/Session/RangeIndexMigrationReceiveSession.cs:ProcessRecord
    pub fn process_record(&self) {}
    /// libs/cluster/Session/RangeIndexMigrationReceiveSession.cs:ProcessRecordInternal
    pub fn process_record_internal(&self) {}
