...
impl LuaLimitedManagedAllocator {
  ...
  /// libs/server/Lua/LuaLimitedManagedAllocator.cs:GetNextFreeBlockRef
  pub fn get_next_free_block_ref() {
    unimplemented!()
  }
  /// libs/server/Lua/LuaLimitedManagedAllocator.cs:GetPrevFreeBlockRef
  pub fn get_prev_free_block_ref() {
    unimplemented!()
  }
  /// libs/server/Lua/LuaLimitedManagedAllocator.cs:GetNextAdjacentBlockRef
  pub fn get_next_adjacent_block_ref() {
    unimplemented!()
  }
  ...
  pub fn enter_infallible_allocation_region() {
    unimplemented!()
  }
  /// libs/server/Lua/LuaLimitedManagedAllocator.cs:TryExitInfallibleAllocationRegion
  pub fn try_exit_infallible_allocation_region() {
    unimplemented!()
  }
  ...
  pub fn update_debug_allocated_bytes() {
    unimplemented!()
  }
