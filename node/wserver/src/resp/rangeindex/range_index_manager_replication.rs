...
impl RangeIndexManager_Replication {
  ...
  pub fn set_aof_stream_chunk_size() {
    unimplemented!()
  }
  ...
  pub fn handle_range_index_stream_replay() {
    unimplemented!()
  }
