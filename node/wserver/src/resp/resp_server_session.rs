...
impl RespServerSession {
  ...
  pub fn update_resp_protocol_version() {
    unimplemented!()
  }
  ...
  /// libs/server/Resp/RespServerSession.cs:NetworkCLIENTID
  pub fn network_clientid() {
    unimplemented!()
  }
  /// libs/server/Resp/RespServerSession.cs:NetworkCustomTxn
  pub fn network_custom_txn() {
    unimplemented!()
  }
  /// libs/server/Resp/RespServerSession.cs:NetworkCustomProcedure
  pub fn network_custom_procedure() {
    unimplemented!()
  }
  /// libs/server/Resp/RespServerSession.cs:Process
  pub fn process() {
    unimplemented!()
  }
  /// libs/server/Resp/RespServerSession.cs:NetworkCustomRawStringCmd
  pub fn network_custom_raw_string_cmd() {
    unimplemented!()
  }
  /// libs/server/Resp/RespServerSession.cs:NetworkCustomObjCmd
  pub fn network_custom_obj_cmd() {
    unimplemented!()
  }
  /// libs/server/Resp/RespServerSession.cs:IsCommandArityValid
  pub fn is_command_arity_valid() {
    unimplemented!()
  }
  ...
  pub fn try_switch_active_database_session() {
    unimplemented!()
  }
  /// libs/server/Resp/RespServerSession.cs:TrySwapDatabaseSessions
  pub fn try_swap_database_sessions() {
    unimplemented!()
  }
  ...
  pub fn create_database_session() {
    unimplemented!()
  }
  ...
  pub fn switch_active_database_session() {
    unimplemented!()
  }
