...
impl VectorManager {
  ...
  pub fn recovered_vector_set_index_key() {
    unimplemented!()
  }
  /// libs/server/Resp/Vector/VectorManager.cs:RecoveredContextMetadata
  pub fn recovered_context_metadata() {
    unimplemented!()
  }
  ...
  pub fn fetch_vector_element_attributes() {
    unimplemented!()
  }
  ...
  pub fn assert_have_storage_session() {
    unimplemented!()
  }
}
