...
const ENGINE_TABLES_LI = [
  {
    ...
    metric_li: [
      ...
      { key: "wkv_get_immutable", label: "不可变区点查 (Get Immutable)" },
      { key: "wkv_ycsb_mixed", label: "YCSB 读写混合 (zipf 50/50)" },
    ],
  },
  {
    name: "wbftree",
    metric_li: [
      ...
      { key: "wbftree_scan_50", label: "范围扫描 (Range Scan 50)" },
  ...
  },
  {
    name: "wepoch/whlog",
    metric_li: [
      { key: "wepoch_protect", label: "纪元保护域进出 (Protect)" },
      { key: "whlog_page_load", label: "混合日志页装载回读 (Page Load)" },
    ],
  },
  {
    name: "wresp",
    metric_li: [
      { key: "resp_parse", label: "RESP 端到端解析 (Parse Cmd/s)" },
      { key: "resp_encode", label: "RESP 端到端编码 (Encode Reply/s)" },
    ],
  },
  {
    name: "wdev",
    metric_li: [
      { key: "wdev_write_page", label: "设备层直写页 (Write Page/s)" },
      { key: "wdev_read_page", label: "设备层直读页 (Read Page/s)" },
    ],
  },
];
