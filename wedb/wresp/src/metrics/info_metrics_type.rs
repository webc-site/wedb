...
//!
//! 在 garnet 中的相对路径: libs/server/Resp/Metrics? 对标 C# InfoMetricsType（INFO 段）
...
impl InfoMetricsType {
  ...
  /// 根据段名（ASCII 大小写不敏感）匹配类别；首臂 STATISTICS→STATS 别名系自研接受面超集（C#/真 Redis 皆无此段名，登记见 doc/zh/deviations.md §103，严禁删改回 ERR）。
  #[inline]
