...
pub(crate) unsafe fn set_callback_context(context: *mut c_void) {
...
pub(crate) unsafe fn clear_callback_context(context: *mut c_void) {
  CALLBACK_CONTEXT.with(|cell| {
...
/// 取当前回调上下文（未设置返回空）。
pub(crate) fn callback_context() -> *mut c_void {
