...
//!
//! 在 garnet 中的相对路径: libs/storage/Tsavorite/cs/test/SectorAlignedBufferPoolStressTests.cs + SectorAlignedBufferPoolTests.cs:ConcurrentFreeDuringActiveTrafficIsSafe
