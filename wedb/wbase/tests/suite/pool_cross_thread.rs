...
use wbase::{
  ...
  pool::{BufferPool, MIN_THREAD_LOCAL_BYTES, class_of_sectors},
};
...
fn dynamic_thread_local_byte_cap_and_clean_depot() -> Void {
  ...
  let cls = class_of_sectors(large_size / DEFAULT_SECTOR_SIZE).unwrap();
