...
impl TlsPoolEntry {
  ...
  /// 将缓冲推入本地私有栈并记账 (对标 libs/storage/Tsavorite/cs/src/core/Utilities/BufferPool.OriginReturn.cs:RetainLocal 与 CallerLocalBytesForClass)
  #[inline]
  ...
  /// 清空并释放当前 entry 中属于该池的所有本地及在途缓冲许可 (对标 libs/storage/Tsavorite/cs/src/core/Utilities/BufferPool.OriginReturn.cs:SealAndDrainShard 与 ReleaseChainPermits)
...
impl TlsPoolManager {
  ...
  /// 按 pool_id 查找可变条目 (对标 libs/storage/Tsavorite/cs/src/core/Utilities/BufferPool.OriginReturn.cs:CallerShard)
