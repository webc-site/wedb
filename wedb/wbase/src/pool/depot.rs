...
impl DepotStripe {
  ...
  /// 弹出栈顶缓冲 (对标 libs/storage/Tsavorite/cs/src/core/Utilities/BufferPool.OriginReturn.cs:TryPop)
  #[inline]
...
impl Depot {
  ...
  /// 弹出：优先尝试本线程条带，若空则工作窃取其他条带 (对标 libs/storage/Tsavorite/cs/src/core/Utilities/BufferPool.OriginReturn.cs:DepotPop)
