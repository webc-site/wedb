...
pub use pool::{
  ...
  DEPOT_STRIPE_CAP, EventWorkQueue, EventWorkSet, LARGE_TIER_MIN_BYTES, LimitedFixedBufferPool,
  MAX_LOCAL_PER_CLASS, MAX_POOLED_SECTORS, MIN_THREAD_LOCAL_BYTES, NUM_CLASSES,
  NetworkBufferSettings, PoolStats, PooledBuffer, class_capacity_bytes, class_capacity_sectors,
  class_of_sectors,
};
#[cfg(feature = "pool")]
pub mod throttle;
