...
#[compio::test]
async fn hlog_scan_empty_then_populated() -> Void {
...
#[compio::test]
async fn hlog_scan_state_distribution() -> Void {
...
#[compio::test]
async fn hlog_scan_in_place_update_stays_live() -> Void {
...
#[compio::test]
async fn hlog_scan_immutable_region_after_head_shift() -> Void {
