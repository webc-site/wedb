...
pub use wbase::{
  ...
  MAX_POOLED_SECTORS, MIN_THREAD_LOCAL_BYTES, NUM_CLASSES, PoolStats, Result, class_capacity_bytes,
  class_capacity_sectors, class_of_sectors, current_thread_id,
};
