...
impl Participant {
  ...
  /// 别名：进入受保护的纪元区，返回 RAII 守卫 `EpochGuard`
  #[inline]
  ...
  ///
  /// 对照 C# LightEpoch 的 ProtectAndDrain 语义（主映射归属 LightEpoch::refresh_participant；本函数为会话句柄层拆分路径）
...
impl crate::EpochAccessor for Participant {
  #[inline]
