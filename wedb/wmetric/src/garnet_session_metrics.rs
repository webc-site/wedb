...
impl GarnetSessionMetrics {
  ...
  get_total_transaction_commands_received: total_transactions_commands_received,
  get_total_transaction_commands_execution_failed: total_transaction_commands_execution_failed,
...
impl SessionMetricsHandle {
  ...
  incr_total_transaction_commands_received: total_transactions_commands_received,
  incr_total_transaction_execution_failed: total_transaction_commands_execution_failed,
