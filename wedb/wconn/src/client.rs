...
impl GarnetClient {
  ...
  ///
  /// 通道在位且网络泵仍存活：泵任务退出（EOF/断链/协议错误）即 rx 全部
  /// 丢弃，发送端 `is_disconnected` 翻真——零轮询零探测包，与
  ...
  /// libs/client/GarnetClientAPI/GarnetClientClusterCommands.cs:ExecuteForMemoryResultWithCancellationAsync
