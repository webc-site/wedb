...
#[inline(always)]
fn resolve_read_cache(rc_skip: &impl Fn(u64) -> u64, raw: u64) -> u64 {
...
impl<'a, F: Fn(u64) -> u64> BatchWriter<'a, F> {
  fn new(file: &'a mut File, hasher: &'a mut Crc32Hasher, start_pos: u64, rc_skip: &'a F) -> Self {
    Self {
      file,
      hasher,
