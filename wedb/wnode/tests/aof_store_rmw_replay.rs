...
#[compio::test]
async fn store_rmw_replay_unknown_cmd_fails_recover() {
...
#[compio::test]
async fn store_rmw_replay_unknown_cmd_in_txn_group_propagates() {
  let dir = tempfile::tempdir().unwrap();
...
#[compio::test]
async fn store_rmw_replay_expire_relative_form_fails_recover() {
  let dir = tempfile::tempdir().unwrap();
