...
use wnode::{GarnetServer, ServerTlsConfig, service::StorageSessionProvider};
...
fn spawn_server(
  ...
  let server = if tls {
    ...
    let tls_config = ServerTlsConfig::from_der(
    ...
    let client_config = ClientConfig::builder()
      ...
      .with_no_client_auth();
    connector = Some(Arc::new(TlsConnector::from(Arc::new(client_config))));
