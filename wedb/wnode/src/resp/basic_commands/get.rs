...
impl RespServerSession {
  ...
  pub fn network_get<'a, D: wdev::Device>(
    ...
    match read_user_sync(store, key, self.session_metrics.as_deref(), |v| {
  ...
  pub fn network_get_range<'a, D: wdev::Device>(
    ...
    match read_user_sync(store, key, self.session_metrics.as_deref(), |val| {
  ...
  pub fn network_strlen<'a, D: wdev::Device>(
    ...
    match read_user_sync(store, key, self.session_metrics.as_deref(), |v| v.len()) {
