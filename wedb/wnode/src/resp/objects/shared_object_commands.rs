...
use wresp::{RespSliceExt, cmd_strings as cs};

use crate::{
  inputs::ObjectInput,
  objects::types::object_output::ObjectOutput,
  resp::{objects::object_store_utils::make_object_input, resp_server_session::RespServerSession},
...
impl RespServerSession {
  ...
  pub fn object_scan(
    ...
    let input = make_object_input(object_type, 0, &parse_state[1..], 0, scan_count_limit);
