...
use crate::resp::{
  objects::object_store_utils::{
    ElementHeaderKind, ObjLoad, RespRmwOutcome, SyncRmwCmd, SyncRmwHandlers, hash_from_blob,
    hash_to_blob, make_object_input, obj_load_typed_sync, parse_elements_header, run_sync_rmw,
    write_n2_array,
  },
...
impl RespServerSession {
  ...
  pub fn hash_time_to_live<'a, D: wdev::Device>(
    ...
    let key = parse_state[0];
    let Some((fields_start, num_fields)) =
