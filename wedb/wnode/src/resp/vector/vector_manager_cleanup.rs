...
//! Rust 侧以 std 线程 + [`crate::resp::vector::cleanup::vector_set_cleanup_work_channel::VectorSetCleanupWorkChannel`] + [`CleanupGate`]
...
mod tests {
  ...
  fn drop_request_wait_and_checkpoint_flow() {
    ...
    manager.service.create_index(9, record.hnsw_config());
