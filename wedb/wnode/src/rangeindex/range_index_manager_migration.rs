...
use gxhash::HashSet;
use wbftree::{
  DEFAULT_FILE_READ_BUFFER_SIZE, RangeIndexChunkedSerializer, RangeIndexManager,
  RangeIndexMigrationReader, StorageBackendType,
};
use wdev::Device;
...
impl RangeIndexManagerMigration {
  ...
  pub async fn publish_migrated_index<D: Device>(
    ...
    match session
      .publish_migrated_range_index(key, stub_bytes, temp_path, replace, obj_type)
      .await
    {
