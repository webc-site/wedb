...
//!
//! 写侧布局说明：周期 1 的 [`crate::aof::garnet_log::GarnetLog::enqueue_span_chunked`] 以“帧头 +
...
use super::aof_header::{AofChunkHeader, AofHeader, AofHeaderType, AofShardedHeader};
...
mod tests {
  ...
  fn read_chunk_reassembles_from_cycle1_writer() {
    let records = chunked_upsert_entry(200);
