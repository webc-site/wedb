...
/// 测试 RangeIndexResult 状态码转换 (1:1 对标 Garnet RangeIndexResult)
#[test]
fn test_range_index_result_mapping() {
  use wbftree::{BfTreeDeleteResult, BfTreeInsertResult, BfTreeReadResult, RangeIndexResult};

  assert_eq!(
    RangeIndexResult::from(BfTreeReadResult::Found),
    RangeIndexResult::Ok
  );
  assert_eq!(
    RangeIndexResult::from(BfTreeReadResult::NotFound),
    RangeIndexResult::NotFound
  );
  assert_eq!(
    RangeIndexResult::from(BfTreeReadResult::Deleted),
    RangeIndexResult::Deleted
  );
  assert_eq!(
    RangeIndexResult::from(BfTreeReadResult::InvalidKey),
    RangeIndexResult::InvalidKey
  );
  assert_eq!(
    RangeIndexResult::from(BfTreeReadResult::InvalidArguments),
    RangeIndexResult::Error
  );

  assert_eq!(
    RangeIndexResult::from(BfTreeInsertResult::Success),
    RangeIndexResult::Ok
  );
  assert_eq!(
    RangeIndexResult::from(BfTreeInsertResult::InvalidKV),
    RangeIndexResult::InvalidKey
  );
  assert_eq!(
    RangeIndexResult::from(BfTreeInsertResult::InvalidArguments),
    RangeIndexResult::Error
  );

  assert_eq!(
    RangeIndexResult::from(BfTreeDeleteResult::Success),
    RangeIndexResult::Ok
  );
  assert_eq!(
    RangeIndexResult::from(BfTreeDeleteResult::InvalidArguments),
    RangeIndexResult::Error
  );
}
