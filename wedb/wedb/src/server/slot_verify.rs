use wresp::{
  cluster_cmd_strings::{RESP_ERR_CLUSTERDOWN, RESP_ERR_TRYAGAIN, write_redirect_error},
...
/// 渲染单点（C# RespClusterSlotVerify.cs GetSlotVerificationMessage +
/// WriteClusterSlotVerificationMessage：按 state 查 config 取端点后经
/// RespWriteUtils 组帧）
///
...
pub fn write_slot_verification_message(
  ...
  match vres.state {
    ...
    SlotVerifiedState::ClusterDown => write_error_raw(output, RESP_ERR_CLUSTERDOWN),
    SlotVerifiedState::TryAgain => write_error_raw(output, RESP_ERR_TRYAGAIN),
    SlotVerifiedState::Ok => {}
  }
}

/// C# ClusterSlotVerify.cs:SingleKeySlotVerify
///
...
/// C# ClusterSlotVerify.cs:SingleKeyReadSlotVerify
///
...
/// C# ClusterSlotVerify.cs:SingleKeyReadWriteSlotVerify
///
