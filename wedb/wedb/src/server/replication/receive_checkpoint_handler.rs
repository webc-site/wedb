...
/// 文件段接收槽（libs/cluster/Server/Replication/ReplicaOps/
/// DiskbasedReplication/FileDataSink.cs:FileDataSink；C# 的 Type 属性由
/// 开槽期类型分派消化，rust 槽体只保留 token 防串流）
struct FileDataSink {
  token: u128,
  target: SinkTarget,
}
...
impl FileDataSink {
  ...
  /// RangeIndex 检查点快照槽（libs/cluster/Server/Replication/ReplicaOps/
  /// DiskbasedReplication/RangeIndexFileDataSink.cs:FromMetadata
  /// libs/cluster/Server/Replication/ReplicaOps/DiskbasedReplication/RangeIndexFileDataSink.cs:Dispose）：
  ...
  /// 定位写一个段（libs/cluster/Server/Replication/ReplicaOps/
  /// DiskbasedReplication/FileDataSink.cs:WriteChunk
  /// libs/cluster/Server/Replication/ReplicaOps/DiskbasedReplication/RangeIndexFileDataSink.cs:WriteChunk）
  ...
  /// 流收尾刷盘（libs/cluster/Server/Replication/ReplicaOps/
  /// DiskbasedReplication/FileDataSink.cs:Complete
  /// libs/cluster/Server/Replication/ReplicaOps/DiskbasedReplication/RangeIndexFileDataSink.cs:Complete）
...
/// 元数据接收槽（libs/cluster/Server/Replication/ReplicaOps/
/// DiskbasedReplication/MetadataDataSink.cs:MetadataDataSink）
///
...
impl MetadataDataSink {
  ...
  /// libs/cluster/Server/Replication/ReplicaOps/DiskbasedReplication/
  /// MetadataDataSink.cs:WriteChunk
  ///
  /// libs/cluster/Server/Replication/ReplicaOps/DiskbasedReplication/
  /// MetadataDataSink.cs:Complete
  ///
...
/// 检查点网络接收处理器（libs/cluster/Server/Replication/ReplicaOps/
/// DiskbasedReplication/ReceiveCheckpointHandler.cs:ReceiveCheckpointHandler）
///
...
impl ReceiveCheckpointHandler {
  /// libs/cluster/Server/Replication/ReplicaOps/DiskbasedReplication/
  /// ReceiveCheckpointHandler.cs:ReceiveCheckpointHandler（构造）
  pub fn new() -> Self {
    Self::default()
  }

  /// 同步尝试状态复位（对标 C# TryReplicateDiskbasedSyncAsync 内
  ...
  /// 统一接收入口（libs/cluster/Server/Replication/ReplicaOps/
  /// DiskbasedReplication/ReceiveCheckpointHandler.cs:ProcessSnapshotData）
  ///
  ...
  pub async fn process_snapshot_data(
    ...
    if start_address == SINGLE_MESSAGE_ADDRESS {
      return match file_type {
        ...
        // RangeIndex 检查点快照头帧（libs/cluster/Server/Replication/
        // ReplicaOps/DiskbasedReplication/RangeIndexFileDataSink.cs:FromMetadata）：
  ...
  /// 文件段接收（libs/cluster/Server/Replication/ReplicaOps/
  /// DiskbasedReplication/ReceiveCheckpointHandler.cs:ProcessFileSegment）
  ///
  ...
  /// 元数据接收（libs/cluster/Server/Replication/ReplicaOps/
  /// DiskbasedReplication/ReceiveCheckpointHandler.cs:ProcessMetadata）
  ///
