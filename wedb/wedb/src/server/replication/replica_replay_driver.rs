...
use crate::server::replication::driver_registry::DriverLifecycle;
...
impl ReplicaReplayDriver {
  ...
  /// libs/cluster/Server/Replication/ReplicaOps/AOFReplay/ReplicaReplayDriver.cs:AppliedPulseSequenceNumber
  ///
  /// 获取最新处理的时间脉冲序列号
