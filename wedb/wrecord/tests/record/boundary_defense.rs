...
use wrecord::{
  Error, HEADER_SIZE, MAX_KEY_LEN, RecordHeader, RecordMut, RecordRef, checked_record_size,
...
fn test_near_4gb_and_overflow_defense() -> Void {
  ...
  // 1. 键长 24 位位段上限与值长 u32 上限的尺寸计算
  //    （对标 C# KeyLength 10 位位段上限语义：Rust 键长位段 24 位，超出经 build_header 拦截）
