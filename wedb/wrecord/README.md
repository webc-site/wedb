...
- `tag`: 1-byte physical `KeyTag` (String=0x00 / Meta=0x01 / Hash=0x02 / Set=0x03 / Ttl=0x09 / Vector=0x0A / Etag=0x0B / ObjectEnvelope=0x0C) and `CollectionType` (SortedSet=1 / List=2 / Hash=3 / Set=4 / RangeIndex=5)
...
- `tag`：物理键 1 字节 `KeyTag`（String=0x00 / Meta=0x01 / Hash=0x02 / Set=0x03 / Ttl=0x09 / Vector=0x0A / Etag=0x0B / ObjectEnvelope=0x0C）与 `CollectionType`（SortedSet=1 / List=2 / Hash=3 / Set=4 / RangeIndex=5）
